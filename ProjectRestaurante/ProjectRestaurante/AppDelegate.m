...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    Mesa *m1 = [[Mesa alloc]initWithId:1 NumeroComensales:3];
    Mesa *m2 = [[Mesa alloc]initWithId:2 NumeroComensales:3];
    Mesa *m3 = [[Mesa alloc]initWithId:3 NumeroComensales:3];
